...
always_comb begin
    ...
    if (pulse_gen_count == 16'd3550 || pulse_gen_count == 16'd3551) begin
        mic_pcm_0 = 16'sd6000;
        pulse_high = 1'b1;
    end

    if (pulse_gen_count == 16'd3650 || pulse_gen_count == 16'd3651) begin
        mic_pcm_1 = 16'sd6000;
        pulse_high = 1'b1;
    end

    if (pulse_gen_count == 16'd3850 || pulse_gen_count == 16'd3851) begin
        mic_pcm_2 = 16'sd6000;
        pulse_high = 1'b1;
    end

    if (pulse_gen_count == 16'd3640 || pulse_gen_count == 16'd3641) begin
        mic_pcm_3  = 16'sd6000;
        pulse_high = 1'b1;
    end
end
