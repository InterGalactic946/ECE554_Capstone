	soc_system u0 (
		.axi_signals_awcache                   (<connected-to-axi_signals_awcache>),                   //               axi_signals.awcache
		.axi_signals_awprot                    (<connected-to-axi_signals_awprot>),                    //                          .awprot
		.axi_signals_awuser                    (<connected-to-axi_signals_awuser>),                    //                          .awuser
		.axi_signals_arcache                   (<connected-to-axi_signals_arcache>),                   //                          .arcache
		...
		.data_cntrl_export                     (<connected-to-data_cntrl_export>),                     //                data_cntrl.export
		.fifo_in_writedata                     (<connected-to-fifo_in_writedata>),                     //                   fifo_in.writedata
		.fifo_in_write                         (<connected-to-fifo_in_write>),                         //                          .write
		.fifo_in_waitrequest                   (<connected-to-fifo_in_waitrequest>),                   //                          .waitrequest
		...
		.mcu_axi_signals_export                (<connected-to-mcu_axi_signals_export>),                //           mcu_axi_signals.export
