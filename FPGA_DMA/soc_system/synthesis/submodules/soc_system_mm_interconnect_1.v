...
module soc_system_mm_interconnect_1 (
		...
		input  wire        pio_1_reset_reset_bridge_in_reset_reset,                             //                             pio_1_reset_reset_bridge_in_reset.reset
	...
	wire          dma_0_control_port_slave_agent_rp_valid;                      // dma_0_control_port_slave_agent:rp_valid -> router_002:sink_valid
	wire  [113:0] dma_0_control_port_slave_agent_rp_data;                       // dma_0_control_port_slave_agent:rp_data -> router_002:sink_data
	wire          dma_0_control_port_slave_agent_rp_ready;                      // router_002:sink_ready -> dma_0_control_port_slave_agent:rp_ready
	wire          dma_0_control_port_slave_agent_rp_startofpacket;              // dma_0_control_port_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          dma_0_control_port_slave_agent_rp_endofpacket;                // dma_0_control_port_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [113:0] pio_0_s1_agent_rp_data;                                       // pio_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire          pio_1_s1_agent_rp_valid;                                      // pio_1_s1_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] pio_1_s1_agent_rp_data;                                       // pio_1_s1_agent:rp_data -> router_004:sink_data
	wire          pio_1_s1_agent_rp_ready;                                      // router_004:sink_ready -> pio_1_s1_agent:rp_ready
	wire          pio_1_s1_agent_rp_startofpacket;                              // pio_1_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          pio_1_s1_agent_rp_endofpacket;                                // pio_1_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                            // cmd_mux:src_valid -> dma_0_control_port_slave_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_src_data;                                             // cmd_mux:src_data -> dma_0_control_port_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                            // dma_0_control_port_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                          // cmd_mux:src_channel -> dma_0_control_port_slave_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                    // cmd_mux:src_startofpacket -> dma_0_control_port_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                      // cmd_mux:src_endofpacket -> dma_0_control_port_slave_burst_adapter:sink0_endofpacket
	...
	wire    [2:0] dma_0_control_port_slave_burst_adapter_source0_channel;       // dma_0_control_port_slave_burst_adapter:source0_channel -> dma_0_control_port_slave_agent:cp_channel
	...
	wire  [113:0] cmd_mux_001_src_data;                                         // cmd_mux_001:src_data -> pio_0_s1_burst_adapter:sink0_data
	...
	wire  [113:0] pio_0_s1_burst_adapter_source0_data;                          // pio_0_s1_burst_adapter:source0_data -> pio_0_s1_agent:cp_data
	wire          pio_0_s1_burst_adapter_source0_ready;                         // pio_0_s1_agent:cp_ready -> pio_0_s1_burst_adapter:source0_ready
	wire    [2:0] pio_0_s1_burst_adapter_source0_channel;                       // pio_0_s1_burst_adapter:source0_channel -> pio_0_s1_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                        // cmd_mux_002:src_valid -> pio_1_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                         // cmd_mux_002:src_data -> pio_1_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                        // pio_1_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                      // cmd_mux_002:src_channel -> pio_1_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                // cmd_mux_002:src_startofpacket -> pio_1_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                  // cmd_mux_002:src_endofpacket -> pio_1_s1_burst_adapter:sink0_endofpacket
	wire          pio_1_s1_burst_adapter_source0_valid;                         // pio_1_s1_burst_adapter:source0_valid -> pio_1_s1_agent:cp_valid
	wire  [113:0] pio_1_s1_burst_adapter_source0_data;                          // pio_1_s1_burst_adapter:source0_data -> pio_1_s1_agent:cp_data
	wire          pio_1_s1_burst_adapter_source0_ready;                         // pio_1_s1_agent:cp_ready -> pio_1_s1_burst_adapter:source0_ready
	wire    [2:0] pio_1_s1_burst_adapter_source0_channel;                       // pio_1_s1_burst_adapter:source0_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [113:0] cmd_demux_src2_data;                                          // cmd_demux:src2_data -> crosser:in_data
	wire          cmd_demux_src2_ready;                                         // crosser:in_ready -> cmd_demux:src2_ready
	wire    [2:0] cmd_demux_src2_channel;                                       // cmd_demux:src2_channel -> crosser:in_channel
	...
	wire  [113:0] crosser_out_data;                                             // crosser:out_data -> cmd_mux_002:sink0_data
	...
	wire  [113:0] cmd_demux_001_src2_data;                                      // cmd_demux_001:src2_data -> crosser_001:in_data
	wire          cmd_demux_001_src2_ready;                                     // crosser_001:in_ready -> cmd_demux_001:src2_ready
	wire    [2:0] cmd_demux_001_src2_channel;                                   // cmd_demux_001:src2_channel -> crosser_001:in_channel
	...
	wire  [113:0] crosser_001_out_data;                                         // crosser_001:out_data -> cmd_mux_002:sink1_data
	wire          crosser_001_out_ready;                                        // cmd_mux_002:sink1_ready -> crosser_001:out_ready
	wire    [2:0] crosser_001_out_channel;                                      // crosser_001:out_channel -> cmd_mux_002:sink1_channel
	...
	wire  [113:0] rsp_demux_002_src0_data;                                      // rsp_demux_002:src0_data -> crosser_002:in_data
	wire          rsp_demux_002_src0_ready;                                     // crosser_002:in_ready -> rsp_demux_002:src0_ready
	wire    [2:0] rsp_demux_002_src0_channel;                                   // rsp_demux_002:src0_channel -> crosser_002:in_channel
	...
	wire  [113:0] crosser_002_out_data;                                         // crosser_002:out_data -> rsp_mux:sink2_data
	wire          crosser_002_out_ready;                                        // rsp_mux:sink2_ready -> crosser_002:out_ready
	wire    [2:0] crosser_002_out_channel;                                      // crosser_002:out_channel -> rsp_mux:sink2_channel
	...
	wire  [113:0] rsp_demux_002_src1_data;                                      // rsp_demux_002:src1_data -> crosser_003:in_data
	wire          rsp_demux_002_src1_ready;                                     // crosser_003:in_ready -> rsp_demux_002:src1_ready
	wire    [2:0] rsp_demux_002_src1_channel;                                   // rsp_demux_002:src1_channel -> crosser_003:in_channel
	...
	wire  [113:0] crosser_003_out_data;                                         // crosser_003:out_data -> rsp_mux_001:sink2_data
	wire          crosser_003_out_ready;                                        // rsp_mux_001:sink2_ready -> crosser_003:out_ready
	wire    [2:0] crosser_003_out_channel;                                      // crosser_003:out_channel -> rsp_mux_001:sink2_channel
	...
	wire          dma_0_control_port_slave_agent_rdata_fifo_out_valid;          // dma_0_control_port_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] dma_0_control_port_slave_agent_rdata_fifo_out_data;           // dma_0_control_port_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          dma_0_control_port_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter:in_0_ready -> dma_0_control_port_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                // avalon_st_adapter:out_0_valid -> dma_0_control_port_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                 // avalon_st_adapter:out_0_data -> dma_0_control_port_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                // dma_0_control_port_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                // avalon_st_adapter:out_0_error -> dma_0_control_port_slave_agent:rdata_fifo_sink_error
	...
	wire          pio_1_s1_agent_rdata_fifo_out_valid;                          // pio_1_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] pio_1_s1_agent_rdata_fifo_out_data;                           // pio_1_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          pio_1_s1_agent_rdata_fifo_out_ready;                          // avalon_st_adapter_002:in_0_ready -> pio_1_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (pio_1_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                //             clk.clk
		.reset                   (pio_1_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (pio_1_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	soc_system_mm_interconnect_1_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (pio_1_reset_reset_bridge_in_reset_reset),                             // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (pio_1_reset_reset_bridge_in_reset_reset),                             //  in_clk_reset.reset
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_rst_0_reset (pio_1_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
