// ------------------------------------------------------------
// Module: Fetch
// Description: Instruction Fetch stage of the processor.
//              Maintains the program counter (PC), computes
//              the next PC, and interfaces with the dynamic
//              branch predictor to obtain predicted branch
...
module Fetch (
  ...
  // Compute PC_next_o as the next instruction address.
