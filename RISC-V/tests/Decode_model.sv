...
module Decode_model (
    ...
    input logic [15:0] EX_result,          // Result from the EX stage (ALU output)
    input logic [15:0] MEM_result,         // Result from the MEM stage
  ...
  logic [15:0] Rs_data;       // Data from the first source register (Rs) for branch instructions
  ///////////////////////////// EXECUTE STAGE ////////////////////////////////////
  ...
  // Get the second ALU input as the second register read out.
