  ...
  always @(posedge clk) begin
      if (rst_n) begin
        ...
        verify_DECODE(
            ...
            .flag_reg(iDUT.iPROC.flags),
            .is_branch(iDUT.iPROC.iDECODE.is_branch),
            .expected_is_branch(iMODEL.iPROC.iDECODE.is_branch),
    ...
    always @(posedge clk) begin
      if (rst_n) begin
        ...
        verify_EXECUTE(
          ...
          .expected_Input_A(iMODEL.iPROC.iEXECUTE.iALU.Input_A),
          .expected_Input_B(iMODEL.iPROC.iEXECUTE.iALU.Input_B),
          ...
          .ZF(iDUT.iPROC.iEXECUTE.ZF),
          .NF(iDUT.iPROC.iEXECUTE.NF),
          .VF(iDUT.iPROC.iEXECUTE.VF),
          .expected_ZF(iMODEL.iPROC.iEXECUTE.ZF),
          .expected_VF(iMODEL.iPROC.iEXECUTE.VF),
          .expected_NF(iMODEL.iPROC.iEXECUTE.NF),
