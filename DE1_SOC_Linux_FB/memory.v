...
module mem_wrapper (
    ...
    input wire [2:0] address,      // 2-bit address for 8 values
    input wire read,                // Read request
    output reg [15:0] readdata,     // 16-bit read data (one row)
    ...
    wire [15:0] mem_rdata;
    reg [2:0] read_address;  // Latched address for the read operation
