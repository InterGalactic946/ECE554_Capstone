// soc_system_alt_vip_cl_cvo_0_video_in.v
...
`timescale 1 ps / 1 ps
module soc_system_alt_vip_cl_cvo_0_video_in (
		input  wire        main_clock_clk,              //    main_clock.clk
		input  wire        main_reset_reset,            //    main_reset.reset
		input  wire [31:0] av_st_vid_din_data,          // av_st_vid_din.data
		...
		output wire [63:0] av_st_dout_data,             //              .data
		input  wire        av_st_dout_ready             //              .ready
	);

	wire         vid_front_av_st_dout_valid;         // vid_front:av_st_dout_valid -> vid_back:av_st_din_valid
	wire  [63:0] vid_front_av_st_dout_data;          // vid_front:av_st_dout_data -> vid_back:av_st_din_data
