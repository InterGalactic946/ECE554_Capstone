...
module soc_system_mm_interconnect_1 (
		...
		input  wire [5:0]   alt_vip_cl_vfb_0_mem_master_rd_burstcount,                        //                                                           .burstcount
		input  wire         alt_vip_cl_vfb_0_mem_master_rd_read,                              //                                                           .read
		output wire [255:0] alt_vip_cl_vfb_0_mem_master_rd_readdata,                          //                                                           .readdata
	...
	wire  [255:0] alt_vip_cl_vfb_0_mem_master_rd_translator_avalon_universal_master_0_readdata;      // alt_vip_cl_vfb_0_mem_master_rd_agent:av_readdata -> alt_vip_cl_vfb_0_mem_master_rd_translator:uav_readdata
	...
	wire   [31:0] alt_vip_cl_vfb_0_mem_master_rd_translator_avalon_universal_master_0_byteenable;    // alt_vip_cl_vfb_0_mem_master_rd_translator:uav_byteenable -> alt_vip_cl_vfb_0_mem_master_rd_agent:av_byteenable
	...
	wire  [255:0] alt_vip_cl_vfb_0_mem_master_rd_translator_avalon_universal_master_0_writedata;     // alt_vip_cl_vfb_0_mem_master_rd_translator:uav_writedata -> alt_vip_cl_vfb_0_mem_master_rd_agent:av_writedata
	...
	wire  [121:0] master_secure_master_agent_cp_data;                                                // master_secure_master_agent:cp_data -> router:sink_data
	...
	wire          alt_vip_cl_vfb_0_mem_master_rd_agent_cp_valid;                                     // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_valid -> router_001:sink_valid
	wire  [373:0] alt_vip_cl_vfb_0_mem_master_rd_agent_cp_data;                                      // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_data -> router_001:sink_data
	wire          alt_vip_cl_vfb_0_mem_master_rd_agent_cp_ready;                                     // router_001:sink_ready -> alt_vip_cl_vfb_0_mem_master_rd_agent:cp_ready
	wire          alt_vip_cl_vfb_0_mem_master_rd_agent_cp_startofpacket;                             // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          alt_vip_cl_vfb_0_mem_master_rd_agent_cp_endofpacket;                               // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_endofpacket -> router_001:sink_endofpacket
	wire          hps_0_f2h_axi_slave_agent_write_rp_valid;                                          // hps_0_f2h_axi_slave_agent:write_rp_valid -> router_002:sink_valid
	wire  [229:0] hps_0_f2h_axi_slave_agent_write_rp_data;                                           // hps_0_f2h_axi_slave_agent:write_rp_data -> router_002:sink_data
	...
	wire  [229:0] router_002_src_data;                                                               // router_002:src_data -> rsp_demux:sink_data
	...
	wire  [229:0] hps_0_f2h_axi_slave_agent_read_rp_data;                                            // hps_0_f2h_axi_slave_agent:read_rp_data -> router_003:sink_data
	...
	wire  [229:0] router_003_src_data;                                                               // router_003:src_data -> rsp_demux_001:sink_data
	...
	wire  [121:0] router_src_data;                                                                   // router:src_data -> master_secure_master_limiter:cmd_sink_data
	...
	wire  [121:0] master_secure_master_limiter_rsp_src_data;                                         // master_secure_master_limiter:rsp_src_data -> master_secure_master_agent:rp_data
	...
	wire          router_001_src_valid;                                                              // router_001:src_valid -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_valid
	wire  [373:0] router_001_src_data;                                                               // router_001:src_data -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                              // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                                            // router_001:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_channel
	wire          router_001_src_startofpacket;                                                      // router_001:src_startofpacket -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_startofpacket
	wire          router_001_src_endofpacket;                                                        // router_001:src_endofpacket -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_sink_endofpacket
	...
	wire  [373:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_rsp_src_data;                               // alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_src_data -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_data
	...
	wire  [229:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> hps_0_f2h_axi_slave_wr_burst_adapter:sink0_data
	...
	wire  [229:0] hps_0_f2h_axi_slave_wr_burst_adapter_source0_data;                                 // hps_0_f2h_axi_slave_wr_burst_adapter:source0_data -> hps_0_f2h_axi_slave_agent:write_cp_data
	...
	wire  [229:0] cmd_mux_001_src_data;                                                              // cmd_mux_001:src_data -> hps_0_f2h_axi_slave_rd_burst_adapter:sink0_data
	...
	wire  [229:0] hps_0_f2h_axi_slave_rd_burst_adapter_source0_data;                                 // hps_0_f2h_axi_slave_rd_burst_adapter:source0_data -> hps_0_f2h_axi_slave_agent:read_cp_data
	...
	wire  [229:0] cmd_demux_src0_data;                                                               // cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	wire  [229:0] cmd_demux_src1_data;                                                               // cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [229:0] cmd_demux_001_src0_data;                                                           // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [229:0] cmd_demux_001_src1_data;                                                           // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [229:0] rsp_demux_src0_data;                                                               // rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	wire  [229:0] rsp_demux_src1_data;                                                               // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [229:0] rsp_demux_001_src0_data;                                                           // rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	wire  [229:0] rsp_demux_001_src1_data;                                                           // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [121:0] master_secure_master_limiter_cmd_src_data;                                         // master_secure_master_limiter:cmd_src_data -> master_secure_master_cmd_width_adapter:in_data
	...
	wire          master_secure_master_cmd_width_adapter_src_valid;                                  // master_secure_master_cmd_width_adapter:out_valid -> cmd_demux:sink_valid
	wire  [229:0] master_secure_master_cmd_width_adapter_src_data;                                   // master_secure_master_cmd_width_adapter:out_data -> cmd_demux:sink_data
	wire          master_secure_master_cmd_width_adapter_src_ready;                                  // cmd_demux:sink_ready -> master_secure_master_cmd_width_adapter:out_ready
	wire    [1:0] master_secure_master_cmd_width_adapter_src_channel;                                // master_secure_master_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	wire          master_secure_master_cmd_width_adapter_src_startofpacket;                          // master_secure_master_cmd_width_adapter:out_startofpacket -> cmd_demux:sink_startofpacket
	wire          master_secure_master_cmd_width_adapter_src_endofpacket;                            // master_secure_master_cmd_width_adapter:out_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                                 // rsp_mux:src_valid -> master_secure_master_rsp_width_adapter:in_valid
	wire  [229:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> master_secure_master_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                                 // master_secure_master_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> master_secure_master_rsp_width_adapter:in_channel
	wire          rsp_mux_src_startofpacket;                                                         // rsp_mux:src_startofpacket -> master_secure_master_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_src_endofpacket;                                                           // rsp_mux:src_endofpacket -> master_secure_master_rsp_width_adapter:in_endofpacket
	...
	wire  [121:0] master_secure_master_rsp_width_adapter_src_data;                                   // master_secure_master_rsp_width_adapter:out_data -> master_secure_master_limiter:rsp_sink_data
	...
	wire    [0:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_valid;                              // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_valid -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_valid
	wire  [373:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_data;                               // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_data -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_data
	wire          alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_ready;                              // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_ready -> alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_ready
	wire    [1:0] alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_channel;                            // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_channel -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_channel
	wire          alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_startofpacket;                      // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_startofpacket -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_startofpacket
	wire          alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_endofpacket;                        // alt_vip_cl_vfb_0_mem_master_rd_limiter:cmd_src_endofpacket -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_endofpacket
	wire          alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_valid;                        // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_valid -> cmd_demux_001:sink_valid
	wire  [229:0] alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_data;                         // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_data -> cmd_demux_001:sink_data
	wire          alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_ready;                        // cmd_demux_001:sink_ready -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_ready
	wire    [1:0] alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_channel;                      // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_channel -> cmd_demux_001:sink_channel
	wire          alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_startofpacket;                // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_endofpacket;                  // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_endofpacket -> cmd_demux_001:sink_endofpacket
	wire          rsp_mux_001_src_valid;                                                             // rsp_mux_001:src_valid -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_valid
	wire  [229:0] rsp_mux_001_src_data;                                                              // rsp_mux_001:src_data -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_data
	wire          rsp_mux_001_src_ready;                                                             // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                           // rsp_mux_001:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_channel
	wire          rsp_mux_001_src_startofpacket;                                                     // rsp_mux_001:src_startofpacket -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                       // rsp_mux_001:src_endofpacket -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_endofpacket
	wire          alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_valid;                        // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_valid -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_valid
	wire  [373:0] alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_data;                         // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_data -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_data
	wire          alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_ready;                        // alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_ready -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_ready
	wire    [1:0] alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_channel;                      // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_channel -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_channel
	wire          alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_startofpacket;                // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_startofpacket -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_startofpacket
	wire          alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_endofpacket;                  // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_endofpacket -> alt_vip_cl_vfb_0_mem_master_rd_limiter:rsp_sink_endofpacket
	...
	altera_merlin_master_agent #(
		...
		.PKT_QOS_H                 (358),
		.PKT_QOS_L                 (358),
		.PKT_DATA_SIDEBAND_H       (356),
		.PKT_DATA_SIDEBAND_L       (356),
		.PKT_ADDR_SIDEBAND_H       (355),
		.PKT_ADDR_SIDEBAND_L       (351),
		.PKT_BURST_TYPE_H          (350),
		.PKT_BURST_TYPE_L          (349),
		.PKT_CACHE_H               (368),
		.PKT_CACHE_L               (365),
		.PKT_THREAD_ID_H           (361),
		.PKT_THREAD_ID_L           (361),
		.PKT_BURST_SIZE_H          (348),
		.PKT_BURST_SIZE_L          (346),
	...
	altera_merlin_axi_slave_ni #(
		...
		.PKT_CACHE_H                 (224),
		.PKT_CACHE_L                 (221),
		.PKT_DATA_SIDEBAND_H         (212),
		.PKT_DATA_SIDEBAND_L         (212),
		.PKT_ADDR_SIDEBAND_H         (211),
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_valid          (alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_valid),               //          .valid
		.rsp_sink_ready         (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_ready),         //  rsp_sink.ready
		.rsp_sink_valid         (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_valid),         //          .valid
		.rsp_sink_channel       (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_channel),       //          .channel
		.rsp_sink_data          (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_data),          //          .data
		.rsp_sink_startofpacket (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.rsp_sink_endofpacket   (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_endofpacket),   //          .endofpacket
	...
	soc_system_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.sink_ready         (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_channel),       //          .channel
		.sink_data          (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_data),          //          .data
		.sink_startofpacket (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_valid),         //          .valid
	...
	soc_system_mm_interconnect_1_cmd_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.IN_PKT_BURSTWRAP_H            (345),
		.IN_PKT_BURSTWRAP_L            (337),
		.IN_PKT_BURST_SIZE_H           (348),
		.IN_PKT_BURST_SIZE_L           (346),
		.IN_PKT_RESPONSE_STATUS_H      (370),
		.IN_PKT_RESPONSE_STATUS_L      (369),
		.IN_PKT_TRANS_EXCLUSIVE        (325),
		.IN_PKT_BURST_TYPE_H           (350),
		.IN_PKT_BURST_TYPE_L           (349),
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                      //       clk.clk
		.reset                (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_valid             (alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_valid),               //      sink.valid
		.in_channel           (alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_channel),             //          .channel
		.in_startofpacket     (alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_startofpacket),       //          .startofpacket
		.in_endofpacket       (alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_endofpacket),         //          .endofpacket
		.in_ready             (alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_ready),               //          .ready
		.in_data              (alt_vip_cl_vfb_0_mem_master_rd_limiter_cmd_src_data),                //          .data
		.out_endofpacket      (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_data),          //          .data
		.out_channel          (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                              // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.OUT_PKT_BURST_SIZE_H          (348),
		.OUT_PKT_BURST_SIZE_L          (346),
		.OUT_PKT_RESPONSE_STATUS_H     (370),
		.OUT_PKT_RESPONSE_STATUS_L     (369),
		.OUT_PKT_TRANS_EXCLUSIVE       (325),
		.OUT_PKT_BURST_TYPE_H          (350),
		.OUT_PKT_BURST_TYPE_L          (349),
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                      //       clk.clk
		.reset                (alt_vip_cl_vfb_0_mem_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		...
		.out_endofpacket      (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_data),          //          .data
		.out_channel          (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                              // (terminated)
	);
