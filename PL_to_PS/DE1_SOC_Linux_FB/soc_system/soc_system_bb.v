...
module soc_system (
	...
	reset_reset_n,
	shared_data_address,
	shared_data_chipselect,
	shared_data_clken,
	shared_data_write,
	shared_data_readdata,
	shared_data_writedata,
	shared_data_byteenable);	
	...
	input		reset_reset_n;
	input	[9:0]	shared_data_address;
	input		shared_data_chipselect;
	input		shared_data_clken;
	input		shared_data_write;
	output	[31:0]	shared_data_readdata;
	input	[31:0]	shared_data_writedata;
	input	[3:0]	shared_data_byteenable;
endmodule
