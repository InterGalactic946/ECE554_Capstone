	component soc_system is
		port (
			...
			shared_data_address                          : in    std_logic_vector(9 downto 0)  := (others => 'X'); -- address
			shared_data_chipselect                       : in    std_logic                     := 'X';             -- chipselect
			shared_data_clken                            : in    std_logic                     := 'X';             -- clken
			shared_data_write                            : in    std_logic                     := 'X';             -- write
			shared_data_readdata                         : out   std_logic_vector(31 downto 0);                    -- readdata
			shared_data_writedata                        : in    std_logic_vector(31 downto 0) := (others => 'X'); -- writedata
			shared_data_byteenable                       : in    std_logic_vector(3 downto 0)  := (others => 'X')  -- byteenable
		);
	...
	u0 : component soc_system
		port map (
			...
			shared_data_address                          => CONNECTED_TO_shared_data_address,                          --                    shared_data.address
			shared_data_chipselect                       => CONNECTED_TO_shared_data_chipselect,                       --                               .chipselect
			shared_data_clken                            => CONNECTED_TO_shared_data_clken,                            --                               .clken
			shared_data_write                            => CONNECTED_TO_shared_data_write,                            --                               .write
			shared_data_readdata                         => CONNECTED_TO_shared_data_readdata,                         --                               .readdata
			shared_data_writedata                        => CONNECTED_TO_shared_data_writedata,                        --                               .writedata
			shared_data_byteenable                       => CONNECTED_TO_shared_data_byteenable                        --                               .byteenable
		);
