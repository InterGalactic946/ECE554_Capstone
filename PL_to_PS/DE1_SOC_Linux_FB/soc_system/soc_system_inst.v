	soc_system u0 (
		...
		.shared_data_address                          (<connected-to-shared_data_address>),                          //                    shared_data.address
		.shared_data_chipselect                       (<connected-to-shared_data_chipselect>),                       //                               .chipselect
		.shared_data_clken                            (<connected-to-shared_data_clken>),                            //                               .clken
		.shared_data_write                            (<connected-to-shared_data_write>),                            //                               .write
		.shared_data_readdata                         (<connected-to-shared_data_readdata>),                         //                               .readdata
		.shared_data_writedata                        (<connected-to-shared_data_writedata>),                        //                               .writedata
		.shared_data_byteenable                       (<connected-to-shared_data_byteenable>)                        //                               .byteenable
	);
